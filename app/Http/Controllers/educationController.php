...
class educationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('education.index')->with('success', 'Berhasil add data education');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('education.index')->with('success', 'Berhasil update data experience');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('education.index')->with('success', 'Berhasil delete data experience');
    }
}
